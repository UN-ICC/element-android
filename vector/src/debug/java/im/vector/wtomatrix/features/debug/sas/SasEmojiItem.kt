...
package im.vector.wtomatrix.features.debug.sas
...
@EpoxyModelClass(layout = im.vector.wtomatrix.R.layout.item_sas_emoji)
abstract class SasEmojiItem : VectorEpoxyModel<SasEmojiItem.Holder>() {
    ...
    class Holder : VectorEpoxyHolder() {
        val indexView by bind<TextView>(im.vector.wtomatrix.R.id.sas_emoji_index)
        val emojiView by bind<TextView>(im.vector.wtomatrix.R.id.sas_emoji)
        val textView by bind<TextView>(im.vector.wtomatrix.R.id.sas_emoji_text)
        val idView by bind<TextView>(im.vector.wtomatrix.R.id.sas_emoji_text_id)
    }
}
