...
package im.vector.wtomatrix.features.signout.soft
...
import im.vector.wtomatrix.core.extensions.toReducedUrl
import im.vector.wtomatrix.core.resources.StringProvider
import im.vector.wtomatrix.features.login.LoginMode
import im.vector.wtomatrix.features.signout.soft.epoxy.loginCenterButtonItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginErrorWithRetryItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginHeaderItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginPasswordFormItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginRedButtonItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginTextItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginTitleItem
import im.vector.wtomatrix.features.signout.soft.epoxy.loginTitleSmallItem
