...
class DialPadFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        digits?.setTextColor(ThemeUtils.getColor(requireContext(), im.vector.wtomatrix.R.attr.riotx_text_primary))
        ...
        if (enableDelete) {
            ...
            val tintColor = ThemeUtils.getColor(requireContext(), im.vector.wtomatrix.R.attr.riotx_text_secondary)
