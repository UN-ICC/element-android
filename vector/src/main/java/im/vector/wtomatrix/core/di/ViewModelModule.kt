...
import im.vector.wtomatrix.core.platform.ConfigurationViewModel
import im.vector.wtomatrix.features.call.SharedKnownCallsViewModel
import im.vector.wtomatrix.features.crypto.keysbackup.restore.KeysBackupRestoreFromKeyViewModel
import im.vector.wtomatrix.features.crypto.keysbackup.restore.KeysBackupRestoreFromPassphraseViewModel
import im.vector.wtomatrix.features.crypto.keysbackup.restore.KeysBackupRestoreSharedViewModel
import im.vector.wtomatrix.features.crypto.keysbackup.setup.KeysBackupSetupSharedViewModel
import im.vector.wtomatrix.features.discovery.DiscoverySharedViewModel
import im.vector.wtomatrix.features.home.HomeSharedActionViewModel
import im.vector.wtomatrix.features.home.room.detail.RoomDetailSharedActionViewModel
...
import im.vector.wtomatrix.features.reactions.EmojiChooserViewModel
import im.vector.wtomatrix.features.roomdirectory.RoomDirectorySharedActionViewModel
import im.vector.wtomatrix.features.roomprofile.RoomProfileSharedActionViewModel
import im.vector.wtomatrix.features.roomprofile.alias.detail.RoomAliasBottomSheetSharedActionViewModel
import im.vector.wtomatrix.features.roomprofile.settings.historyvisibility.RoomHistoryVisibilitySharedActionViewModel
import im.vector.wtomatrix.features.roomprofile.settings.joinrule.RoomJoinRuleSharedActionViewModel
import im.vector.wtomatrix.features.userdirectory.UserListSharedActionViewModel
