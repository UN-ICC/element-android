...
import im.vector.wtomatrix.features.attachments.preview.AttachmentsPreviewFragment
import im.vector.wtomatrix.features.contactsbook.ContactsBookFragment
import im.vector.wtomatrix.features.crypto.keysbackup.settings.KeysBackupSettingsFragment
import im.vector.wtomatrix.features.crypto.quads.SharedSecuredStorageKeyFragment
import im.vector.wtomatrix.features.crypto.quads.SharedSecuredStoragePassphraseFragment
import im.vector.wtomatrix.features.crypto.quads.SharedSecuredStorageResetAllFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapReAuthFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapConclusionFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapConfirmPassphraseFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapEnterPassphraseFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapMigrateBackupFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapSaveRecoveryKeyFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapSetupRecoveryKeyFragment
import im.vector.wtomatrix.features.crypto.recover.BootstrapWaitingFragment
import im.vector.wtomatrix.features.crypto.verification.QuadSLoadingFragment
import im.vector.wtomatrix.features.crypto.verification.cancel.VerificationCancelFragment
import im.vector.wtomatrix.features.crypto.verification.cancel.VerificationNotMeFragment
import im.vector.wtomatrix.features.crypto.verification.choose.VerificationChooseMethodFragment
import im.vector.wtomatrix.features.crypto.verification.conclusion.VerificationConclusionFragment
import im.vector.wtomatrix.features.crypto.verification.emoji.VerificationEmojiCodeFragment
import im.vector.wtomatrix.features.crypto.verification.qrconfirmation.VerificationQRWaitingFragment
import im.vector.wtomatrix.features.crypto.verification.qrconfirmation.VerificationQrScannedByOtherFragment
import im.vector.wtomatrix.features.crypto.verification.request.VerificationRequestFragment
import im.vector.wtomatrix.features.devtools.RoomDevToolEditFragment
import im.vector.wtomatrix.features.devtools.RoomDevToolFragment
import im.vector.wtomatrix.features.devtools.RoomDevToolSendFormFragment
import im.vector.wtomatrix.features.devtools.RoomDevToolStateEventListFragment
import im.vector.wtomatrix.features.discovery.DiscoverySettingsFragment
import im.vector.wtomatrix.features.discovery.change.SetIdentityServerFragment
import im.vector.wtomatrix.features.grouplist.GroupListFragment
import im.vector.wtomatrix.features.home.HomeDetailFragment
import im.vector.wtomatrix.features.home.HomeDrawerFragment
import im.vector.wtomatrix.features.home.LoadingFragment
import im.vector.wtomatrix.features.home.room.breadcrumbs.BreadcrumbsFragment
import im.vector.wtomatrix.features.home.room.detail.RoomDetailFragment
import im.vector.wtomatrix.features.home.room.detail.search.SearchFragment
import im.vector.wtomatrix.features.home.room.list.RoomListFragment
import im.vector.wtomatrix.features.login.LoginCaptchaFragment
import im.vector.wtomatrix.features.login.LoginFragment
import im.vector.wtomatrix.features.login.LoginGenericTextInputFormFragment
import im.vector.wtomatrix.features.login.LoginResetPasswordFragment
import im.vector.wtomatrix.features.login.LoginResetPasswordMailConfirmationFragment
import im.vector.wtomatrix.features.login.LoginResetPasswordSuccessFragment
import im.vector.wtomatrix.features.login.LoginServerSelectionFragment
import im.vector.wtomatrix.features.login.LoginServerUrlFormFragment
import im.vector.wtomatrix.features.login.LoginSignUpSignInSelectionFragment
import im.vector.wtomatrix.features.login.LoginSplashFragment
import im.vector.wtomatrix.features.login.LoginWaitForEmailFragment
import im.vector.wtomatrix.features.login.LoginWebFragment
import im.vector.wtomatrix.features.login.terms.LoginTermsFragment
import im.vector.wtomatrix.features.pin.PinFragment
import im.vector.wtomatrix.features.qrcode.QrCodeScannerFragment
import im.vector.wtomatrix.features.reactions.EmojiChooserFragment
import im.vector.wtomatrix.features.reactions.EmojiSearchResultFragment
import im.vector.wtomatrix.features.roomdirectory.PublicRoomsFragment
import im.vector.wtomatrix.features.roomdirectory.createroom.CreateRoomFragment
import im.vector.wtomatrix.features.roomdirectory.picker.RoomDirectoryPickerFragment
import im.vector.wtomatrix.features.roomdirectory.roompreview.RoomPreviewNoPreviewFragment
import im.vector.wtomatrix.features.roommemberprofile.RoomMemberProfileFragment
import im.vector.wtomatrix.features.roommemberprofile.devices.DeviceListFragment
import im.vector.wtomatrix.features.roommemberprofile.devices.DeviceTrustInfoActionFragment
import im.vector.wtomatrix.features.roomprofile.RoomProfileFragment
import im.vector.wtomatrix.features.roomprofile.banned.RoomBannedMemberListFragment
import im.vector.wtomatrix.features.roomprofile.members.RoomMemberListFragment
import im.vector.wtomatrix.features.roomprofile.settings.RoomSettingsFragment
import im.vector.wtomatrix.features.roomprofile.alias.RoomAliasFragment
import im.vector.wtomatrix.features.roomprofile.permissions.RoomPermissionsFragment
import im.vector.wtomatrix.features.roomprofile.uploads.RoomUploadsFragment
import im.vector.wtomatrix.features.roomprofile.uploads.files.RoomUploadsFilesFragment
import im.vector.wtomatrix.features.roomprofile.uploads.media.RoomUploadsMediaFragment
import im.vector.wtomatrix.features.settings.VectorSettingsAdvancedNotificationPreferenceFragment
import im.vector.wtomatrix.features.settings.VectorSettingsGeneralFragment
import im.vector.wtomatrix.features.settings.VectorSettingsHelpAboutFragment
import im.vector.wtomatrix.features.settings.VectorSettingsLabsFragment
import im.vector.wtomatrix.features.settings.VectorSettingsNotificationPreferenceFragment
import im.vector.wtomatrix.features.settings.VectorSettingsNotificationsTroubleshootFragment
import im.vector.wtomatrix.features.settings.VectorSettingsPinFragment
import im.vector.wtomatrix.features.settings.VectorSettingsPreferencesFragment
import im.vector.wtomatrix.features.settings.VectorSettingsSecurityPrivacyFragment
import im.vector.wtomatrix.features.settings.account.deactivation.DeactivateAccountFragment
import im.vector.wtomatrix.features.settings.crosssigning.CrossSigningSettingsFragment
import im.vector.wtomatrix.features.settings.devices.VectorSettingsDevicesFragment
import im.vector.wtomatrix.features.settings.devtools.AccountDataFragment
import im.vector.wtomatrix.features.settings.devtools.GossipingEventsPaperTrailFragment
import im.vector.wtomatrix.features.settings.devtools.IncomingKeyRequestListFragment
import im.vector.wtomatrix.features.settings.devtools.KeyRequestsFragment
import im.vector.wtomatrix.features.settings.devtools.OutgoingKeyRequestListFragment
import im.vector.wtomatrix.features.settings.homeserver.HomeserverSettingsFragment
import im.vector.wtomatrix.features.settings.ignored.VectorSettingsIgnoredUsersFragment
import im.vector.wtomatrix.features.settings.locale.LocalePickerFragment
import im.vector.wtomatrix.features.settings.push.PushGatewaysFragment
import im.vector.wtomatrix.features.settings.push.PushRulesFragment
import im.vector.wtomatrix.features.settings.threepids.ThreePidsSettingsFragment
import im.vector.wtomatrix.features.share.IncomingShareFragment
import im.vector.wtomatrix.features.signout.soft.SoftLogoutFragment
import im.vector.wtomatrix.features.terms.ReviewTermsFragment
import im.vector.wtomatrix.features.usercode.ShowUserCodeFragment
import im.vector.wtomatrix.features.userdirectory.UserListFragment
import im.vector.wtomatrix.features.widgets.WidgetFragment
