 ...
 */
package im.vector.wtomatrix.push.fcm

import androidx.fragment.app.Fragment
import im.vector.wtomatrix.features.settings.troubleshoot.NotificationTroubleshootTestManager
import im.vector.wtomatrix.features.settings.troubleshoot.TestAccountSettings
import im.vector.wtomatrix.features.settings.troubleshoot.TestDeviceSettings
import im.vector.wtomatrix.features.settings.troubleshoot.TestNotification
import im.vector.wtomatrix.features.settings.troubleshoot.TestPushRulesSettings
import im.vector.wtomatrix.features.settings.troubleshoot.TestSystemSettings
import im.vector.wtomatrix.gplay.features.settings.troubleshoot.TestFirebaseToken
import im.vector.wtomatrix.gplay.features.settings.troubleshoot.TestPlayServices
import im.vector.wtomatrix.gplay.features.settings.troubleshoot.TestPushFromPushGateway
import im.vector.wtomatrix.gplay.features.settings.troubleshoot.TestTokenRegistration
